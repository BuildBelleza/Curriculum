...
/* `server.listen(8080,() => { console.log('the server is running at PORT 8080')` is starting the
server and listening for incoming requests on port 8080. Once the server is started, it logs a
message to the console indicating that the server is running on port 8080. */
server.listen(8080,() => {
